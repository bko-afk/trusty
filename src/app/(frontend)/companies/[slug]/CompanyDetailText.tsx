      ...
      <section className="container-page py-10">
        <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
          <div id={`company-${activeTab}-panel`} role="tabpanel" className="space-y-8">
            ...
            </> : activeTab === 'reviews' ? <CompanyReviewsPanel slug={slug} companyName={name} overallRating={overallRating} reviewCount={reviewCount} criteriaAverages={criteriaAverages} reviews={reviews} compactHeading /> : <CompanyComplaintsPanel slug={slug} companyName={name} complaints={complaints} totalCount={complaintCount} />}
          </div>
